...
* **الفصل عن الصيانة الميدانية:** يمنع الخلط بين أعمال الصيانة الصريحة (الوقائية Preventive والصيانة العلاجية Corrective) وبين واجهات إدارة المخزن PDR. يتم توفير نقاط ربط وتكامل سلسة دون إشغال مسؤول المخزن بمهام الفنيين وأوامر العمل الميدانية.