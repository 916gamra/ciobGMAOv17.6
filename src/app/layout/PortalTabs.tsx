...
export function PortalTabs() {
  ...
  return (
    <header className="h-[46px] md:h-[52px] bg-[#0a0a0f]/40 backdrop-blur-2xl border border-white/10 rounded-2xl flex items-center px-3 gap-2 shrink-0 w-full overflow-x-auto custom-scrollbar z-[60] shadow-xl my-1">
